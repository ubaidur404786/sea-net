...
\begin{figure}[t]
  ...
  \caption{Accuracy of the competitive models on WebTraffic (11 models, 0.92 $\leq$ Accuracy $<$ 0.94). Bars are sorted best-first; blue marks models proposed in this work and orange our reproduction of the published backbones. Labels read \texttt{encoder\_\_pooling}, abbreviated, where sea\_ marks a component introduced here and mil\_ one reused unchanged from MILLET. The dashed line is the accuracy reported in the MILLET paper. Bands are disjoint, so each model appears in exactly one of Figures 1--3.}
...
\begin{figure}[t]
  ...
  \caption{WebTraffic accuracy against AOPCR (interpretability) for every evaluated model. Spearman rank correlation is 0.19: a value near zero means the two objectives are largely independent, so gains on one do not have to be paid for on the other.}
...
\begin{figure}[t]
  ...
  \caption{WebTraffic accuracy against NDCG@n (explanation quality) for every evaluated model. Spearman rank correlation is 0.65: a value near zero means the two objectives are largely independent, so gains on one do not have to be paid for on the other.}
...
\begin{figure}[t]
  ...
  \caption{Accuracy of the remaining models on WebTraffic (39 models, Accuracy $<$ 0.92). Bars are sorted best-first; blue marks models proposed in this work and orange our reproduction of the published backbones. Labels read \texttt{encoder\_\_pooling}, abbreviated, where sea\_ marks a component introduced here and mil\_ one reused unchanged from MILLET. The dashed line is the accuracy reported in the MILLET paper. Bands are disjoint, so each model appears in exactly one of Figures 1--3.}
...
\begin{figure}[t]
  ...
  \caption{WebTraffic accuracy for all 66 evaluated models, sorted best-first. The main-paper version of this figure shows only the top 10.}
...
\begin{figure}[t]
  ...
  \caption{AOPCR (interpretability) for all 66 evaluated models, sorted best-first. The main-paper version of this figure shows only the top 10.}
...
\begin{figure}[t]
  ...
  \caption{NDCG@n (explanation quality) for all 66 evaluated models, sorted best-first. The main-paper version of this figure shows only the top 10.}
...
\begin{figure}[t]
  ...
  \caption{WebTraffic test loss for all 66 evaluated models, sorted best-first. The main-paper version of this figure shows only the top 10.}
