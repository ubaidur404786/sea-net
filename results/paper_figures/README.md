...
| `table_appendix_full_leaderboard` | 72 | Complete leaderboard: all 72 evaluated models, ranked by WebTraffic accuracy |
| `table_ranking_accuracy` | 28 | Statistical summary over 84 datasets for the 28 fully-swept models: average accuracy rank (1 is best), the per-dataset win/tie/loss record against the published MILLET results (ties are differences within 0 |
