"""
seanet/analysis/figures_stats.py - the "is the difference real?" figures.
...
def critical_difference(mat: pd.DataFrame, higher_better: bool = True,
    ...
    seanet/analysis/stats.py). The bars are the maximal groups with no significant difference inside.
