...
\begin{itemize}\itemsep3pt
  ...
  \item \textbf{Make the dilation cap depend on the series length.} \Cref{app:figures} shows
        accuracy falling with series length (correlation $-0.34$; 0.857 on the short half of the
        archive against 0.755 on the long half), which is what a fixed cap of 16 predicts. Adapting
        the cap is a small change with a clear hypothesis behind it.
