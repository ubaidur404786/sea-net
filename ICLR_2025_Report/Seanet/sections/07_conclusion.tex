...
\begin{itemize}\itemsep3pt
  \item \textbf{Re-train \seanet{} under a longer training configuration.} On the baseline
        architecture, a four-times-longer schedule is worth about 0.016 of \ucr{} accuracy
        (\Cref{app:published}). Giving the \seanet{} encoders the same budget would show whether the
        \ucr{} gap of \Cref{sec:res:ucr} is architectural or only a budget effect. This is the single
