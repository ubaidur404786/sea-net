...
training, by `python scripts/profile_models.py`, into `results/SEA_NET/profile.csv`. The
...
| `python main.py analyse` | `results/analysis/` | everything cross-model: encoder comparison, pooling comparison, Pareto fronts, ranks, significance |
...
| `results/analysis/` (small now that it is PNG-only) | smoke-run outputs, raw Grid5000 console dumps |
